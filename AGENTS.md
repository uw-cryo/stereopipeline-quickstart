...
- Concept/intro pages are authored; the site-wide banner is the only reader-facing WIP signal ([ADR-0017](architecture/0017-retire-per-page-wip-admonitions.md)). Remaining `<!-- FIGURE IDEA: ... -->` comments mark figures that still need full processing runs; don't delete one unless you're replacing it with the actual figure.
